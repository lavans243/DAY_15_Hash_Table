    ...
    public static void search(TreeNode root, int data, TreeNode parent) {
        ...
        if (root.data == data) {
            if (parent == null) {
                ...
                System.out.println("The given element " + data + "  The left node  Parent Node " + parent.data);
            } else {
                System.out
                        .println("The given element " + data + "  The right node  Parent Node " + parent.data);
            }
