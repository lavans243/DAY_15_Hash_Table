...
public class UC1_Htable<K,V> {
    ...
    public UC1_Htable(K key, V value, int hashCode) {
        this.key = key;
        this.value = value;
...
// Class to represent entire hash table
 class Map<K, V> {
    ...
    private ArrayList<UC1_Htable<K, V>> bucketArray;
    ...
    public void remove(K key) {
        ...
        int hashCode = hashCode(key);
        // Get head of chain
        UC1_Htable<K, V> head = bucketArray.get(bucketIndex);
        ...
        UC1_Htable<K, V> temp = head;
        UC1_Htable<K, V> left = temp;
        UC1_Htable<K, V> right = left.next;
    ...
    public void add(K key, V value) {
        ...
        UC1_Htable<K, V> newNode = new UC1_Htable<K, V>(key, value, hashCode);
        newNode.next = head;
    ...
    public void display() {
        ...
        for (UC1_Htable<K, V> head : bucketArray) {
        	UC1_Htable<K, V> temp = head;
            if (head != null)
