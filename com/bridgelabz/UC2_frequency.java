...
public class UC2_frequency<K,V> {
    ...
    UC2_frequency<K, V> next;

    // Parameterized Constructor
    public UC2_frequency(K key, V value, int hashCode) {
        this.key = key;
        this.value = value;
...
// Class to represent entire hash table
 class Map <K, V> {
    ...
    private ArrayList<UC2_frequency<K, V>> bucketArray;
    ...
    public void remove(K key) {
        ...
        int hashCode = hashCode(key);
        // Get head of chain
        UC2_frequency<K, V> head = bucketArray.get(bucketIndex);
        ...
        UC2_frequency<K, V> temp = head;
        UC2_frequency<K, V> left = temp;
        UC2_frequency<K, V> right = left.next;
    ...
    public void add(K key, V value) {
        ...
        UC2_frequency<K, V> newNode = new UC2_frequency<K, V>(key, value, hashCode);
        newNode.next = head;
    ...
    public void display() {
        ...
        for (UC2_frequency<K, V> head : bucketArray) {
        	UC2_frequency<K, V> temp = head;
            if (head != null)
